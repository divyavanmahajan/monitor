...
- **Path to DB**: `~/projects/mesura/data/monitor.db`

## 3. Create Dashboards

### Temperature (Evohome)
Create a **Time series** panel using the `evohome` table:
...
### Energy Meter (P1)
Create a **Time series** panel using the `energy` table:
...
Create a **Time series** panel using the `weather` table:
